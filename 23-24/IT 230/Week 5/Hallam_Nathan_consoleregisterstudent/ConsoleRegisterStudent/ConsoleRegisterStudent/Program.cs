...
namespace ConsoleRegisterStudent
{
    class Program
    {
            ...
            do
            {
                ...
                switch (ValidateChoice(choice, firstChoice, secondChoice, thirdChoice, totalCredit))
                {
                    ...
                    case -3:
                        ...
                        break;
                    case -4:
                        Console.WriteLine("Unexpected error occured while validating course selection...");
                        break;
                    case 0:
		...
		//Prints available courses to console
		void WritePrompt()
        {
		...
		//Prints selected courses to console
        ...
        //Converts int choice to string course
        ...
        //Waits for key input to close console
        void WaitForKey()
        {
